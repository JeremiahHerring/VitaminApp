...
const specializedQuestionSets = {
    ...
    energy: [
        ...
        },
        {
          ...
          options: ["7-10hrs", "4-6hrs", "1-3hrs", "Restless"],          
        },
        {
          numb: 3,
          question: "How often do you rely on caffeine or energy drinks?",
    ...
    hairSkinNails: [
        ...
        },
        {
          ...
          options: ["Yes, not serious", "Yes, serious", "No"],                   
        },
    ],
    immunity: [
        {
