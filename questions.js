...
const specializedQuestionSets = {
  ...
  digestion: [
      {
        numb: 1,
        question: "Do you have any digestive issues? (such as Crohn’s disease)",
        options: ["Yes", 
        "No", 
        "Unsure"],
      },
      {
        numb: 2,
        question: "Do you experience, more than often, stomach pain?",
        options: ["Yes", 
        "No"],
      },
      {
        ...
        options: ["Normal", "Diarhea", "Constipation"],
      },
  ],
  hairSkinNails: [
      {
  ...
  immunity: [
      {
        numb: 1,
        question: "How would you describe your overall immune health?",
        options: ["Normal", 
        "Abnormal"],
      },
      {
        numb: 2,
        question: "Have you been diagnosed with a genetic disorder/disease?",
        options: ["Yes", 
        "No", 
        "Unsure"],
      },
      {
        numb: 3,
        question: "Are you taking any supplements or vitamins that are believed to boost immunity? If yes, please list them.",
        options: ["Option 1", 
        "Option 2", 
        "Option 3"],
      },
  ...
  organs: [
      {
        numb: 1,
        question: "How is your Liver health?",
        options: ["Normal", 
        "Abnormal", 
        "Unsure"],
      },
      {
        numb: 2,
        question: "How is your Kidney health?",
        options: ["Normal", 
        "Abnormal", 
        "Unsure"],
      },
      {
        numb: 3,
        question: "How is your Cardiac health?",
        options: ["Normal", 
        "Abnormal", 
        "Unsure"],
      },
